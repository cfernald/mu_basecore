...
class CompilerPlugin(ICiBuildPlugin):
    ...
    def RunsOnTargetList(self):
        return ["DEBUG", "RELEASE", "NOOPT"] # MU_CHANGE: Enable NOOPT build to generate notes files.
    ...
    def RunBuildPlugin(self, packagename, Edk2pathObj, pkgconfig, environment, PLM, PLMHelper, tc, output_stream=None):
        ...
        AP = Edk2pathObj.GetAbsolutePathOnThisSystemFromEdk2RelativePath(packagename) # MU_CHANGE
